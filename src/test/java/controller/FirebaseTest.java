...
public class FirebaseTest {
    ...
    public static void testAddPepe(){
        ...
        try {
            pepeID = Firebase.addPepe(testID, pepe);
    ...
    public void testGetPepe(){
        try {
            Pepe pepeFirebase = Firebase.getPepe(testID, pepeID);
    ...
    public void testGetAllPepe(){
        try {
            Map<String, Pepe> pepeMap = Firebase.getAllPepes(testID);
    ...
    public void testUpdatePepe(){
        try {
            pepe.setRarity(5);
            Pepe pepeFirebase = Firebase.updatePepe(testID, pepeID, pepe);
            assertTrue(pepe.equals(pepeFirebase));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void removePepe(){
        try {
            Firebase.removePepe(testID, pepeID);
            pepeID = null;
            pepe = null;
        } catch (IOException e) {
            e.printStackTrace();
